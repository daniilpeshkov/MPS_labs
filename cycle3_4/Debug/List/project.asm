...
; 0000 0024 unsigned int s[] = {4, 3, 2};
; 0000 0025 int i;
...
; 0000 0030 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=In
; 0000 0031 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (1<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(2)
	OUT  0x4,R30
; 0000 0032 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=T
...
; 0000 0044 // Mode: Fast PWM top=ICR1
; 0000 0045 // OC1A output: Non-Inverted PWM
; 0000 0046 // OC1B output: Disconnected
; 0000 0047 // Noise Canceler: Off
; 0000 0048 // Input Capture on Falling Edge
; 0000 0049 // Timer Period: 0.030125 ms
; 0000 004A // Output Pulse(s):
; 0000 004B // OC1A Period: 0.030125 ms Width: 1.8828 us
...
; 0000 0050 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (1<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(130)
	STS  128,R30
; 0000 0051 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (1<<WGM13) | (1<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(25)
	STS  129,R30
...
; 0000 0053 TCNT1L=0x00;
	STS  132,R30
; 0000 0054 ICR1H= (TOP>>8) & 0xFF;
	LDI  R30,LOW(4)
	STS  135,R30
; 0000 0055 ICR1L= TOP & 0xFF;
	LDI  R30,LOW(117)
	STS  134,R30
; 0000 0056 OCR1AH=0x00;
	LDI  R30,LOW(0)
	STS  137,R30
; 0000 0057 OCR1AL=0xF0;
	LDI  R30,LOW(240)
	STS  136,R30
...
; 0000 005F // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 0060 // USART Receiver: Off
; 0000 0061 // USART Transmitter: On
; 0000 0062 // USART0 Mode: Asynchronous
; 0000 0063 // USART Baud Rate: 9600
; 0000 0064 UCSR0A=(0<<RXC0) | (0<<TXC0) | (0<<UDRE0) | (0<<FE0) | (0<<DOR0) | (0<<UPE0) | (0<<U2X0) | (0<<MPCM0);
	STS  192,R30
; 0000 0065 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (1<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	LDI  R30,LOW(8)
	STS  193,R30
; 0000 0066 UCSR0C=(0<<UMSEL01) | (0<<UMSEL00) | (0<<UPM01) | (0<<UPM00) | (0<<USBS0) | (1<<UCSZ01) | (1<<UCSZ00) | (0<<UCPOL0);
	LDI  R30,LOW(6)
	STS  194,R30
; 0000 0067 UBRR0H=0x00;
	LDI  R30,LOW(0)
	STS  197,R30
; 0000 0068 UBRR0L=0x33;
	LDI  R30,LOW(51)
	STS  196,R30
; 0000 0069 
; 0000 006A i = 0;
...
; 0000 006C       {
; 0000 006D 
; 0000 006E         OCR1AH=((TOP/s[i]) >> 8) & 0xFF;
	CALL SUBOPT_0x0
	MOV  R30,R31
	LDI  R31,0
	STS  137,R30
; 0000 006F 		OCR1AL= (TOP/s[i]) & 0xFF;
	CALL SUBOPT_0x0
	STS  136,R30
; 0000 0070 
; 0000 0071       	i++;
	__ADDWRN 16,17,1
; 0000 0072       	if ( i == sizeof(s)/sizeof(s[0])) {
	LDI  R30,LOW(3)
	LDI  R31,HIGH(3)
	CP   R30,R16
	CPC  R31,R17
